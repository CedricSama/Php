<?php
    ...
    class UserRepository{
        ...
        public function createUser(User $user){
            $sql = "INSER INTO {$this->table_name}(login,password,email,prenom,nom,is_admin,created_at,updated_at) VALUES (:login,:password,:email,:prenom,:nom,:created_at,:updated_at)";
