                                ...
                                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                    <tr>
                                        <td class="pull-left mobile-header-padding-left"
                                            ...
                                            <a href=""><img width="137" height="47"
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="mini-block">
                                                                ...
                                                                {{$commande->civilite}} {{$commande->prenom}} {{$commande->nom}}
                                                                <br>
                                                                {{$commande->adresse}} {{$commande->adresse2}} <br>
                                                                {{$commande->ville}} {{$commande->code_postal}} {{$commande->pays}}
                                                                <br>
                                                        ...
                                                        <tr>
                                                            <td class="mini-block">
                                                                <span class="header-sm">
                                                                    <Strong>Date de la commande: <br>
                                                                        {{\Carbon\Carbon::parse($commande->created_at)->format('d-m-Y H:i')}}</Strong><br/>
                                                                    <br/></span>
                                                            </td>
                                                        </tr>
                                                    </table>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                @foreach($commande->produits as $produit)
                                    <tr>
                                                ...
                                                <tr>
                                                    <td class="mobile-hide-img">
                                                        <img width="110" height="92"
                                                             src="{{asset('uploads/'.$produit->photo)}}"
                                                             alt="item1">
                                                    </td>
                                                    <td class="product">
                                                        <span style="color: #4d4d4d; font-weight:bold;">{{$produit->nom}}</span>
                                        ...
                                        <td class="item-col">
                                            {{number_format($produit->pivot->prix_total_ttc,2) }} €
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                @if(empty($commande->nom_remise_appliquee))
                                    <tr>
                                        ...
                                        <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                                            <span class="total-space">Total HT</span> <br/>
                                            <span class="total-space">TVA 20%</span> <br/>
                                            <span class="total-space">TOTAL TTC</span> <br/>

                                        </td>
                                        <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
            <span class="total-space">{{number_format($commande->prix_total_ht,2)}}</span>
                                            <br/>
             <span class="total-space">{{number_format($commande->prix_total_ttc - $commande->prix_total_ht,2)}}€</span> <br/>

            <span class="total-space" style="font-weight:bold; color: #4d4d4d">{{number_format($commande->prix_total_ttc,2)}}€</span>
                                        </td>
                                    </tr>
                                @else
                                    <tr>
                                        <td width="150" class="item-col item">
                                        </td>
                                        <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
<span class="total-space">Remise {{$commande->nom_remise_appliquee}}</span> <br/>
<span class="total-space">Sous-Total TTC</span> <br/>
<span class="total-space">TOTAL HT</span> <br/>
<span class="total-space">TVA 20%</span> <br/>
<span class="total-space">TOTAL TTC</span> <br/>
                                        ...
                                        <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
<span class="total-space">{{$commande->montant_de_la_remise_appliquee}}</span><br/>
<span class="total-space">{{number_format($commande->prix_total_ttc,2)}} €</span><br/>
<span class="total-space">{{number_format($commande->prix_total_promo_ht,2)}} €</span><br/>
<span class="total-space">{{$commande->prix_total_promo_ttc - $commande->prix_total_promo_ht}} €</span><br/>
<span class="total-space" style="font-weight:bold; color: #4d4d4d">{{number_format($commande->prix_total_promo_ttc,2)}} €</span>
                                        </td>
                                    </tr>
 @endif
