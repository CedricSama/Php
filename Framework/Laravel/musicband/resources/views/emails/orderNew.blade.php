        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    ...
                    <tr>
                        <td class="free-text">
                            We wanted to let you know that we just shipped off your order <a href="">#23141</a>. You'll
                        ...
                        <td class="button">
                            <div><!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                    ...
                                    <w:anchorlock/>
                                    <div style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">
                                        !!!!!!!!!!!!!!!!!!!!!!
                                    </div>
                                </v:roundrect>
                                <![endif]--><a href="http://"
                                               style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:normal;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Track
                                    Order</a></div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%">
                                ...
                                @foreach($commande->produits as $product)
                                    <tr>
                                        <td class="item-col item">
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td class="product">
                                                        <span style="color: #4d4d4d; font-weight:bold;">{{$product->nom}}</span>
                                                    </td>
                                                    <td class="product">
                                                        <span style="color: #4d4d4d; font-weight:bold;">
                                                            {{number_format($product->pivot->prix_unit_ttc, 2)}} €
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td class="item-col">
                                            {{number_format($product->pivot->prix_total_ttc, 2)}} €
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                                        @if(empty($commande->remise_name))
                                            ...
                                            <span class="total-space">{{number_format($commande->prix_total_ht, 2)}} €</span> <br/>
                                        ...
                                        <span class="total-space">{{number_format($commande->prix_total_promo_ttc, 2)}} €</span> <br/>
                                    </td>
                                </tr>
                            </table>
                        </td>
